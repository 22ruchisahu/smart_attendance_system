...
const AlertContextProvider = ({ children }) => {
  ...
  function Message() {
    ...
    let res = {
      success: function (message, autoClose = true, duration = 2000) {
      ...
      error: function (message, autoClose = true, duration = 2000) {
        console.log(message, autoClose, duration);
        setAlerts((state) => [
          ...state,
          {
      ...
      warning: function (message, autoClose = true, duration = 2000) {
        console.log(message, autoClose, duration);
        setAlerts((state) => [
          ...state,
          {
